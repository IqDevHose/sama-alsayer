      ...
      <section className="container mx-auto px-6 py-12">
        ...
        <p className="text-lg text-gray-700 leading-relaxed max-w-2xl mx-auto text-center">
          ...
          <ul class="list-disc text-center md:text-right">
            ...
            <li>تجهيز معدات وأدوات الغزل لصالح وزارة الصناعة لصالح شركة الفارس العامة</li>
            <li>تجهيز كراسيات ومضخات دفع الوقود لمصفى الصينية المتنقل عام 2001</li>
            <li>تنصيب وحدة معالجة المياه المالحة لهيئة المناطق الحرة في خور الزبير وتجهيز أنابيب البويلر لمحطة كهرباء جنوب بغداد والدورة الحرارية</li>
            <li>تجهيز فلاتر بالتيين السوبر هيتز لمحطة كهرباء الناصرية عام 2014</li>
